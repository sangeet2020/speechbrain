#!/usr/bin/env/python3
"""Recipe for training a wav2vec-based ctc ASR system with CommonVoice (DE).
...
CommonVoiceCorpus10.0 (DE) dataset 1,211 hrs. It requires no LM.
...
if __name__ == "__main__":
    ...
    with hp.hyperparameter_optimization(objective_key="WER") as hp_ctx: # <-- Initialize the context
        ...
        from tradr_prepare import prepare_tradr  # noqa
