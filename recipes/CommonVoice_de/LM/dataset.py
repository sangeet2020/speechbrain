...
_DL_URL = "http://www.openslr.org/resources/11/librispeech-lm-norm.txt.gz.asd"
...
class LibrispeechLmConfig(datasets.BuilderConfig):
    ...
    lm_corpus_path: Optional[str] = "lm_corpus/orignal_data/de_lm_normalized.txt" # 17M sentences
