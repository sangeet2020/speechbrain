#!/usr/bin/env/python3
"""Recipe for fine-tuning a sequence-to-sequence ASR system
with SAR domain  dataset, which uses CommonVoice pre-trained model.
...
are used as basic recognition tokens. Training was performed on the full
CommonVoice dataset 10.0 (DE).
