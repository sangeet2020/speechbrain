#!/usr/bin/env/python3
"""Recipe for fine-tuning a wav2vec-based ctc ASR system with Viersen (DE).
...
Viersen dataset 15 mins. It requires no LM.
...
if __name__ == "__main__":
    ...
    # 1.  # Dataset prep (parsing Viersen)
    from viersen_prepare import prepare_viersen  # noqa
